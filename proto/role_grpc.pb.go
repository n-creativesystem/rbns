...
func (c *roleClient) DeletePermission(ctx context.Context, in *RoleReleationPermissions, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedRoleServer) DeletePermission(context.Context, *RoleReleationPermissions) (*Empty, error) {
...
func _Role_DeletePermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServer).DeletePermission(ctx, req.(*RoleReleationPermissions))
	}
	return interceptor(ctx, in, info, handler)
}
