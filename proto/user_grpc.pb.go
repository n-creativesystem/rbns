...
func (c *userClient) DeleteRole(ctx context.Context, in *UserRole, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedUserServer) DeleteRole(context.Context, *UserRole) (*Empty, error) {
...
func _User_DeleteRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).DeleteRole(ctx, req.(*UserRole))
	}
	return interceptor(ctx, in, info, handler)
}
