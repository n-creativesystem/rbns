...
func (c *roleClient) DeletePermissions(ctx context.Context, in *RoleReleationPermissions, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ncs.protobuf.Role/DeletePermissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Role_DeletePermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ncs.protobuf.Role/DeletePermissions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *userClient) FindByOrganizationNameAndUserKey(ctx context.Context, in *UserKeyByName, opts ...grpc.CallOption) (*UserEntity, error) {
	out := new(UserEntity)
	err := c.cc.Invoke(ctx, "/ncs.protobuf.User/FindByOrganizationNameAndUserKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) AddRoles(ctx context.Context, in *UserRole, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ncs.protobuf.User/AddRoles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) DeleteRoles(ctx context.Context, in *UserRole, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ncs.protobuf.User/DeleteRoles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_FindByOrganizationNameAndUserKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ncs.protobuf.User/FindByOrganizationNameAndUserKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_AddRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ncs.protobuf.User/AddRoles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_DeleteRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ncs.protobuf.User/DeleteRoles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
